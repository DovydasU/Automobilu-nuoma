...
@section('title', 'Daugiau Naujienu')
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('home') }}">Pagrindinis <i
                                    class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a
                                href="{{ route('blog') }}">Naujienos <i class="ion-ios-arrow-forward"></i></a></span> <span>Daugiau apie Naujienas<i
                                class="ion-ios-arrow-forward"></i></span></p>
                    <h1 class="mb-3 bread">Skaitykite mūsu naujienas</h1>
                </div>
            </div>
        </div>
    </section>
